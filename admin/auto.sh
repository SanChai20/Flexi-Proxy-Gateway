...
export FP_LRU_MAX_CACHE_SIZE=${FP_LRU_MAX_CACHE_SIZE:-200}
...
export FP_HTTP_MAX_POOL_CONNECTIONS_COUNT=${FP_HTTP_MAX_POOL_CONNECTIONS_COUNT:-10}
export FP_HTTP_POOL_MAX_SIZE=${FP_HTTP_POOL_MAX_SIZE:-20}
export FP_HTTP_RETRY_BACKOFF=${FP_HTTP_RETRY_BACKOFF:-0.2}
