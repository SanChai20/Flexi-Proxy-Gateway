...
export FP_LRU_MAX_CACHE_SIZE=${FP_LRU_MAX_CACHE_SIZE:-50}
...
export FP_HTTP_MAX_POOL_CONNECTIONS_COUNT=${FP_HTTP_MAX_POOL_CONNECTIONS_COUNT:-5}
export FP_HTTP_POOL_MAX_SIZE=${FP_HTTP_POOL_MAX_SIZE:-10}
export FP_HTTP_RETRY_BACKOFF=${FP_HTTP_RETRY_BACKOFF:-0.3}
export FP_TOKEN_REFRESH_INTERVAL=${FP_TOKEN_REFRESH_INTERVAL:-600}
export FP_TOKEN_REFRESH_BUFFER=${FP_TOKEN_REFRESH_BUFFER:-1800}
